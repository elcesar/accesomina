...
export function normalizeChilePhone(value) { const digits=String(value||'').replace(/\D/g,'');const national=digits.startsWith('56')?digits.slice(2):digits;return national?`+56${national}`:''; }
