-- Nexo Klar platform administration: commercial control and support metadata for tenants.
...
CREATE TABLE IF NOT EXISTS tenant_commercial_profiles (
  ...
  setup_price_clp INTEGER NOT NULL DEFAULT 0 CHECK (setup_price_clp >= 0),
  ...
  payment_status TEXT NOT NULL DEFAULT 'cortesia',
  renewal_date DATE,
...
CREATE INDEX IF NOT EXISTS idx_tenant_support_tickets_tenant_status
