...
- `outputs/Video_Tutorial_Domian_Nexo_V2.mp4`
...
## Video promocional empresarial

Archivo:

- `outputs/Video_Promocional_Empresas_Domian_Nexo_V2_Final.mp4`

Caracteristicas:

- Duracion: 60,97 segundos.
- Formato vertical 1080 x 1920.
- 30 cuadros por segundo.
- Voz femenina neuronal chilena.
- Mensaje dirigido a empresas y responsables de operaciones, recursos humanos, prevencion, acreditacion y contratos.
- Pantallas enfocadas principalmente en el panel de trabajo.
- Llamado a solicitar una demostracion.
