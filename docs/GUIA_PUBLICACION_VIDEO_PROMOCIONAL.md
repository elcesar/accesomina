# Video promocional para redes sociales
...
- Duracion: 74,77 segundos.
- 30 cuadros por segundo.
- Voz femenina neuronal chilena.
- Capturas reales del software.
- Sin musica protegida por derechos de autor.
- Compatible con Instagram Reels, Facebook, TikTok, LinkedIn y WhatsApp.
...
Una plataforma adaptable para empresas de servicios, mantenimiento, construccion, logistica, energia, industria y mineria.
...
Publicar el video como Reel vertical y activar la opcion de carga en maxima calidad. Mantener el texto principal visible durante los primeros segundos y usar el correo de contacto en la descripcion del anuncio.
