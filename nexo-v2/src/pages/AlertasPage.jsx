...
export default function AlertasPage() {
  ...
  return <section className="nk-module-page">
    <header className="nk-module-header"><div><p className="nk-module-kicker">Alertas de cumplimiento</p><h1>Alertas</h1><p>Revisa pendientes agrupados por persona, cliente, contrato o recurso y regulariza la evidencia desde un solo lugar.</p></div><button className="nk-button nk-button-secondary" onClick={load}><IconRefresh size={16}/>Actualizar</button></header>
