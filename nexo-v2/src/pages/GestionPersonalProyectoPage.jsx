...
function habilitationFor(worker) {
  if (worker.disponibilidad === 'bloqueado') return { label: 'No habilitado', cls: 'nk-badge-error', key: 'blocked' }
