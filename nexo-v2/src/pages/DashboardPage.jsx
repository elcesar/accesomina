...
export default function DashboardPage() {
  ...
  return <section className="nk-dashboard">
    <header className="nk-module-header"><div><p className="nk-module-kicker">{session?.tenant?.name || 'Empresa'}</p><h1>Estado de la operación</h1><p>Identifica rápidamente la capacidad operativa, las restricciones y las alertas que requieren atención.</p></div><button className="nk-button nk-button-secondary" type="button" onClick={load} disabled={loading}><IconRefresh size={16}/>Actualizar</button></header>
