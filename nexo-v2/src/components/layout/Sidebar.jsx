...
const groups = [
  ...
  ['Gestión operacional', [['comunicaciones', 'Comunicaciones y convocatorias', IconBrandWhatsapp], ['vehiculos', 'Flota y equipos móviles', IconCar], ['alojamientos', 'Alojamientos y estadías', IconBed], ['credenciales', 'Credenciales de acceso', IconId]]],
  ['Empresas colaboradoras', [['terceros-subcontratos', 'Terceros y subcontratos', IconSitemap], ['contratos-convenios', 'Convenios y contratos de terceros', IconFileText], ['personal-empresa-servicios', 'Personas de empresas colaboradoras', IconUsers], ['habilitaciones-cumplimiento', 'Habilitaciones y cumplimiento', IconCircleCheck], ['evaluacion-desempeno', 'Evaluación de desempeño', IconChartBar]]],
  ...
  ['Cumplimiento y calidad', [['cumplimiento-corporativo', 'Cumplimiento corporativo', IconBuilding], ['habilitacion-cliente', 'Habilitación del cliente', IconCircleCheck], ['incidentes', 'Incidentes y no conformidades', IconAlertTriangle], ['auditoria', 'Auditoría', IconClipboardCheck]]],
  ['Gestión de proyectos y negocios', [['libro-obra', 'Bitácora operativa', IconBook], ['prospectos', 'Prospectos y oportunidades', IconBriefcase]]],
  ...
  ['Gestión y gobierno', [['reportes', 'Reportes y analítica', IconChartBar], ['configuracion', 'Configuración de la empresa', IconSettings], ['importar-exportar', 'Importar y exportar', IconArrowsExchange], ['usuarios-permisos', 'Usuarios y permisos', IconUsers], ['bitacora', 'Bitácora de cambios', IconHistory], ['privacidad', 'Privacidad y datos', IconShieldLock]]],
