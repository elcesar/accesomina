const moduleDefinitions = {
  ...
  'habilitacion-cliente': { title: 'Habilitación del cliente', description: 'Controla requisitos solicitados por cada cliente.', data: ['acreditacionesMandante', 'requisitosCliente'], action: 'Revisar requisitos', related: ['clientes', 'personas'] },
