const moduleDefinitions = {
  ...
  'libro-obra': { title: 'Libro de Obra', description: 'Registra anotaciones correlativas, compromisos, evidencia y firmas.', data: ['workBookEntries'], action: 'Nueva anotación', related: ['clientes', 'contratos', 'órdenes de servicio'] },
  ...
  'proteccion-epp': { title: 'Protección personal / EPP', description: 'Controla matriz, entregas y reposición de equipos de protección personal.', data: ['eppEntregas', 'inventoryItems'], action: 'Registrar entrega', related: ['personas', 'inventario'] },
  ...
  'contratos-convenios': { title: 'Convenios y contratos de terceros', description: 'Registra contratos y convenios con empresas colaboradoras y sus vigencias.', data: ['convenios', 'contratos'], action: 'Nuevo contrato', related: ['terceros', 'cumplimiento'] },
  ...
  'habilitaciones-cumplimiento': { title: 'Habilitaciones y cumplimiento', description: 'Evalúa requisitos documentales y estado de cumplimiento de empresas colaboradoras.', data: ['habilitaciones', 'subcontratos'], action: 'Revisar requisitos', related: ['terceros', 'auditoría'] },
  ...
  'habilitacion-cliente': { title: 'Requisitos del cliente', description: 'Controla los requisitos solicitados por cada cliente para personas, recursos y servicios.', data: ['acreditacionesMandante', 'requisitosCliente'], action: 'Revisar requisitos', related: ['clientes', 'personas'] },
  ...
  'epp-inventario': { title: 'Inventario de equipos de protección personal', description: 'Controla existencias, tallas, vida útil y reposición de equipos de protección personal.', data: ['inventoryItems', 'eppEntregas'], action: 'Agregar equipo de protección personal', related: ['bodegas', 'personas'] },
