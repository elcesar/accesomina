const statuses = {
  ...
  cancelado: ['Cancelado', 'none'], suspendido: ['Suspendido', 'error'], vencido: ['Vencido', 'error'], rechazado: ['Rechazado', 'error'], restringido: ['Restringido', 'error'], bloqueado: ['Restringido', 'error'], no_habilitado: ['No habilitado', 'error'], sin_informacion: ['Sin información', 'none'],
}
