...
export default function HomeSection({ openPreview, openDemo }) {
  return <section id="inicio" className="nk-hero nk-public-section">
    <div className="nk-hero-copy">
      ...
      <div className="nk-actions"><button className="nk-button nk-button-primary" onClick={openDemo}>Solicitar demostración</button><button className="nk-button nk-button-secondary" onClick={() => document.getElementById('solucion')?.scrollIntoView({ behavior: 'smooth' })}>Ver cómo funciona</button></div>
    ...
    <div className="nk-hero-product">
      <button className="nk-image-button" onClick={openPreview} aria-label="Ampliar vista de Nexo Klar"><img src="/assets/dashboard-demo.png" alt="Panel de control de Nexo Klar" /></button>
