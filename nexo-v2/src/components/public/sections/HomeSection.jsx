...
export default function HomeSection({ openDemo, onNavigate }) {
  return <section id="inicio" className="nk-hero nk-public-section">
    <div className="nk-hero-copy">
      ...
      <h1>Tu operación comienza con un <span>nexo de información confiable.</span></h1>
      <p className="nk-lead">Nexo Klar ordena tu dotación, tus documentos y tus recursos en una sola base de información para simplificar la operación, mantener el cumplimiento visible y tomar mejores decisiones.</p>
